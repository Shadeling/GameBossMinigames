...
public class PSYDictionary<TKey, TValue> : IDictionary<TKey, TValue>
{
    ...
    public PSYDictionary()
        : this(0, null)
    {
    }

    public PSYDictionary(int capacity)
        : this(capacity, null)
    {
    }

    public PSYDictionary(IEqualityComparer<TKey> comparer)
        : this(0, comparer)
    {
    }

    public PSYDictionary(int capacity, IEqualityComparer<TKey> comparer)
    {
        if (capacity < 0)
    ...
    public PSYDictionary(IDictionary<TKey, TValue> dictionary)
        : this(dictionary, null)
    {
    }

    public PSYDictionary(IDictionary<TKey, TValue> dictionary, IEqualityComparer<TKey> comparer)
    ...
    {
        private readonly PSYDictionary<TKey, TValue> _Dictionary;
        ...
        internal Enumerator(PSYDictionary<TKey, TValue> dictionary)
        {
